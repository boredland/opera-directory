...
import { scrapeCntZagreb } from "./houses/cnt-zagreb";
...
import { scrapeEstonianNationalOpera } from "./houses/estonian-national-opera";
...
import { scrapeOperGraz } from "./houses/oper-graz";
...
import { scrapeOperaDeLille } from "./houses/opera-de-lille";
import { scrapeOperaDeLyon } from "./houses/opera-de-lyon";
import { scrapeOperaDeRouenNormandie } from "./houses/opera-de-rouen-normandie";
import { scrapeOperaDeSaintEtienne } from "./houses/opera-de-saint-etienne";
...
import { scrapeSalzburgerLandestheater } from "./houses/salzburger-landestheater";
...
import { scrapeStaatstheaterMeiningen } from "./houses/staatstheater-meiningen";
...
import { scrapeTheaterFuerNiedersachsen } from "./houses/theater-fuer-niedersachsen";
...
import { scrapeTirolerLandestheaterInnsbruck } from "./houses/tiroler-landestheater-innsbruck";
...
export const HOUSE_SCRAPERS: Record<string, HouseScraper> = {
  ...
  "san-francisco-opera": scrapeSanFranciscoOpera,
  "lyric-opera-of-chicago": scrapeLyricOperaOfChicago,
  "los-angeles-opera": scrapeLosAngelesOpera,
  "houston-grand-opera": scrapeHoustonGrandOpera,
  ...
  "cnt-zagreb": scrapeCntZagreb,
  "sofia-opera": scrapeSofiaOpera,
  "armenian-national-opera": scrapeArmenianNationalOpera,
  ...
  "opera-de-lille": scrapeOperaDeLille,
  "opera-de-lyon": scrapeOperaDeLyon,
  "opera-de-rouen-normandie": scrapeOperaDeRouenNormandie,
  "opera-de-saint-etienne": scrapeOperaDeSaintEtienne,
  ...
  "theater-an-der-wien": scrapeTheaterAnDerWien,
  "oper-graz": scrapeOperGraz,
  "landestheater-linz": scrapeLandestheaterLinz,
  "tiroler-landestheater-innsbruck": scrapeTirolerLandestheaterInnsbruck,
  "salzburger-landestheater": scrapeSalzburgerLandestheater,
  "stadttheater-klagenfurt": scrapeStadttheaterKlagenfurt,
  "opernfestspiele-st-margarethen": scrapeOpernfestspieleStMargarethen,
  ...
  "opera-national-de-paris": scrapeOperaNationalDeParis,
  "teatro-real": scrapeTeatroReal,
  ...
  "theater-fuer-niedersachsen": scrapeTheaterFuerNiedersachsen,
  "landesbuehnen-sachsen": scrapeLandesbuehnenSachsen,
  "theater-lueneburg": scrapeTheaterLueneburg,
  ...
  "festival-aix-en-provence": scrapeFestivalAixEnProvence,
